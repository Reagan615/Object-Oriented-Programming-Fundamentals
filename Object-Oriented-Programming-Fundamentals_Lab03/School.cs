...
namespace Object_Oriented_Programming_Fundamentals_Lab03
{
    public class School
    {
        ...
        public static void DeregisterStudent(int studentId, int courseId)
        {
            ...
            {
                throw new Exception("Student not registered in specified cpurse");
            }

            Enrolment deregisteredEnrolment = student._currentEnrolment;

            Course deregisteringCourse = deregisteredEnrolment.Course;
